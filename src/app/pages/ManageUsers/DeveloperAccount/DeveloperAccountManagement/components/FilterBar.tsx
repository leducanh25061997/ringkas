...
export default function FilterBar(props: Props) {
  const { handleFilterData, onSearch } = props;
          ...
          <SearchKey>
            ...
            >
              ...
              <MenuItem
                ...
                sx={{ color: 'text.secondary', width: '100%' }}
                onClick={() => {
                  setSearchKey('ID Card Number');
                  setIsOpen(false);
                  const searchKeyType: string[] = ['NIK'];
                  const params = {
                    ...filter,
                    searchKeyType,
                  };
              ...
              <MenuItem
                ...
                sx={{ color: 'text.secondary', width: '100%' }}
                onClick={() => {
                  setSearchKey('Phone Number');
                  setIsOpen(false);
                  const searchKeyType: string[] = ['PHONE'];
                  const params = {
                    ...filter,
                    searchKeyType,
                  };
              ...
              <MenuItem
                ...
                sx={{ color: 'text.secondary', width: '100%' }}
                onClick={() => {
                  setSearchKey('Company Name');
                  setIsOpen(false);
                  const searchKeyType: string[] = ['COMPANY_NAME'];
                  const params = {
                    ...filter,
                    searchKeyType,
                  };
