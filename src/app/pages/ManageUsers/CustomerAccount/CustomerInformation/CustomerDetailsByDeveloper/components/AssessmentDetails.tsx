...
import { RootCheckbox } from 'app/pages/InventoryManagement/ProjectManagement/CreateProject/components/ProjectInformation';
        ...
        {item?.parameter?.children &&
          item?.parameter?.children.map((data: any) => (
            ...
            >
              ...
              {data.parameter.children &&
                data.parameter.children.map((value: any) => (
                  <div
