    ...
    if (allowInteraction) {
      dispatch(
        actions.fetchEmployeeAccountList({
          ...
          parentUserUuid: userInformation?.userUuid,
        }),
      );
      setFilter({
        ...params,
  ...
  const columns: GridColDef[] = useMemo(
    () => [
      ...
      },
      {
        field: 'roleName',
        flex: 1,
        headerName: t(translations.employManagement.role),
        sortable: false,
        width: 250,
      ...
      {
        field: 'createdDate',
        headerName: t(translations.common.createdDate),
        sortable: false,
        width: 200,
        renderCell: params => (
  ...
  return (
    <>
      ...
      <Table
        ...
        onRowClick={params => {
          navigate(`${path.employeeAccountList}/${params?.id}`);
        }}
      />
      <UpdateStatusDialog
