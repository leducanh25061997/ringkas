...
// import { any } from '../../../PreKprVerification/types';
...
const HistoryLog = ({ partner }: Props) => {
  ...
  useEffect(() => {
    if (!partner?.userUuid) return;
    getData();
  }, [partner?.userUuid]);

  return (
    <div className="bg-[#fff] rounded-[16px] h-full flex flex-col">
      ...
      >
        <HistoryPopup customerInfo={partner} />
      </Dialog>
    </div>
  );
};
